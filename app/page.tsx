...
const faqItems = [
  ...
  {
    question: '年間プランと月額プランの違いは何ですか？',
    answer:
      '年間プランはStandard¥19,800/年（月払い比17%オフ・¥1,650/月相当）、Pro¥49,800/年（¥4,150/月相当）をご用意しています。まとめて支払うことで毎月節約できます。',
  },
  {
    question: 'どのくらいの利益が期待できますか？',
    answer:
      '掲載商品の平均ROIは180%です。仕入れ価格・送料・eBay手数料・PayPal手数料・為替マージンを含む利益シミュレーターで事前に確認できます。個人の実績は商品・状態・市場状況により異なります。',
  },
];
