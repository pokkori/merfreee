        ...
        <section style={{ padding: '80px 16px', background: 'rgba(0,0,0,0.2)' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24 }}>
              {problems.map((p, i) => (
                <div key={i} className="glass-card-mid" style={{ padding: 24 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 16, flexWrap: 'wrap' }}>
              {[
                ...
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                  <div className="glass-card-mid" style={{ padding: '20px 24px', textAlign: 'center', minWidth: 140, transform: step.isCenter ? 'scale(1.05)' : undefined, border: step.isCenter ? `2px solid ${step.color}` : undefined }}>
        ...
        <section id="pricing" style={{ padding: '80px 16px' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 24 }}>
              {/* Starterプラン */}
              <div className="glass-card-mid" style={{ padding: 28 }}>
              ...
              {/* Standardプラン（おすすめ） */}
              <div className="glass-card-mid" style={{ padding: 28, border: '2px solid #00B4D8', position: 'relative' }}>
