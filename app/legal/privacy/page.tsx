      ...
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        >
          ...
          {[
            {
              title: '1. 収集する情報',
              content: '越境アービトラージ（以下「本サービス」）は、サービス提供のために以下の情報を収集します。\n・メールアドレス（アカウント認証用）\n・お支払い情報（KOMOJU経由で処理、カード番号は保存しません）\n・サービス利用履歴（保存したお宝リスト・閲覧履歴）',
            },
            {
              title: '2. 情報の利用目的',
            ...
            {
              title: '4. データの保管',
              content: 'ユーザーデータはSupabase（PostgreSQL）に保管されます。アカウント削除時にはすべての個人データを30日以内に消去します。',
            },
            {
              title: '5. Cookieの使用',
            ...
            {
              title: '6. お問い合わせ',
              content: 'プライバシーポリシーに関するお問い合わせは、support@ecross-arbitrage.jp までご連絡ください。',
            },
          ].map((section) => (
